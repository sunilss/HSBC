...
Module Module1
    ...
    Sub Main()
        ...
        'Dim channel = ChannelFactory(Of ICalculator).CreateChannel(New BasicHttpBinding(), _
        '            New EndpointAddress("http://localhost:9090/HSBCServices/CalculatorService"))
        Dim cFactory = New ChannelFactory(Of ICalculator)("calculatorServiceOnNamedPipe")
        Dim channel = cFactory.CreateChannel()
