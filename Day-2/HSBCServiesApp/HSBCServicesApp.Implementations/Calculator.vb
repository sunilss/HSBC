...
Public Class Calculator
    ...
    Public Function Process(ByVal request As Contracts.MathRequest) As Contracts.MathResult Implements Contracts.IAdvCalculator.Process
        ...
        Select Case request.Operation
            ...
            Case Else
                Dim failureDetail As New OperationFailureDetail _
                    With {.Number1 = request.Number1, .Number2 = request.Number2, _
                          .Operation = request.Operation, _
                          .ErrorMessage = "Invalid operation requested"}

                Throw New FaultException(Of OperationFailureDetail)(failureDetail)
        End Select
    ...
    <OperationBehavior()>
    Public Sub ProcessOneWay(ByVal request As Contracts.MathRequest) _
        Implements Contracts.IAdvOneWayCalculator.ProcessOneWay
